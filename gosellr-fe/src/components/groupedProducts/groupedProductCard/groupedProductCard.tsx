...
const GroupedProductCard = ({ productData }: any) => {
    ...
    return (
        <>
            ...
            <Modal rootClassName='view-grouped-product-modal' open={isViewGroupedProductModal} footer={false} onOk={() => setIsViewGroupedProductModal(false)} onCancel={() => setIsViewGroupedProductModal(false)}>
                <Row gutter={[20, 20]}>
